...
def add(a: Number, b: Number) -> Number:
    ...
    result = a + b
    logging.info(f"Successful addition of {a}, {b}")
    return result
...
def subtract(a: Number, b: Number) -> Number:
    ...
    result = a - b
    logging.info(f"Successful subtraction of {a}, {b}")
    return result
...
def multiply(a: Number, b: Number) -> Number:
    ...
    result = a * b
    logging.info(f"Successful multiplication of {a}, {b}")
    return result
...
def divide(a: Number, b: Number) -> float:
    ...
    if b == 0:
        ...
        logging.info(f"Raise error divide by zero: {a}, {b}")
